...
class CheckoutController extends Controller
{
    ...
    public function stripe()
    {
        ...
        if (isset($_POST['stripeToken'])) {
            ...
            Mail::to(session()->get('customer_email') ?? session()->get('billing_email'))->send(new OrderCompletedEmailToCustomer($subject, $message));
            ...
            return Redirect()->to('/')->with('success', __('customer.payment_successfull_order_has_been_placed'));
        }
    }
