...
class ProductController extends Controller
{
    public function index()
    {
        ...
        $page_title = __('customer.shop');

        return view('pages.shop', compact('shop', 'g_setting', 'products', 'page_title'));
    }
    ...
    public function add_to_cart(Request $request)
    {
        ...
        if (session()->has('cart_product_id')) {
            ...
            if (in_array($product_id, $arr_cart_product_id)) {
                return redirect()->back()->with('error', __('customer.item_already_added_in_cart'));
            }
        }
        ...
        return redirect()->back()->with('success', __('customer.item_added_successfully'));
    }
    ...
    public function cart()
    {
        ...
        $page_title = __('customer.cart');
        return view('pages.cart', compact('g_setting', 'page_title'));
    }
    ...
    public function cart_item_delete($id)
    {
        ...
        return redirect()->back()->with('success', __('customer.item_deleted_from_cart'));
    }
    ...
    public function update_cart(Request $request)
    {
        ...
        return redirect()->back()->with('success', __('customer.cart_updated'));
    }
    ...
    public function checkout()
    {
        ...
        $page_title = __('customer.checkout');
        return view('pages.checkout', compact('g_setting', 'shipping_data', 'page_title'));
    }
    ...
    public function shipping_update(Request $request)
    {
        ...
        return redirect()->back()->with('success', __('customer.shipping_mehtod_added'));
    }
    ...
    public function coupon_update(Request $request)
    {
        ...
        return redirect()->back()->with('success', __('customer.coupon_added'));
    }
}
